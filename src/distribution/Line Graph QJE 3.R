# Line graph, Multiple curves (real, coloured)

# Bhargava, Loewenstein, and Sydnor, (2017),
#   “Choose to Lose” QJE, 1340
...
ggsave(path=output_dir, filename="Line Graph QJE 3.png", width=8, height=6)

# Save as Example
# ggsave(path='src/distribution', filename='Line Graph QJE 3-example.png', width=8, height=6)
