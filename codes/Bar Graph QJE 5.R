...
ggsave(path=output_dir, filename="Bar Graph QJE 5A.png", p1, width=8, height=6)
ggsave(path=output_dir, filename="Bar Graph QJE 5B.png", p2, width=8, height=6)
ggsave(path=output_dir, filename="Bar Graph QJE 5Combined.png", pc, width=8, height=12)

# Save as Example
# ggsave(path="src/others/frequency", filename="Bar Graph QJE 5A-example.png", p1, width=8, height=6)
# ggsave(path="src/others/frequency", filename="Bar Graph QJE 5B-example.png", p2, width=8, height=6)
# ggsave(path="src/others/frequency", filename="Bar Graph QJE 5Combined-example.png", pc, width=8, height=12)
